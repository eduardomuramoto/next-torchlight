...
export default function Footer() {
  return (
    <footer className="bg-background mx-20 text-center text-surface/75 text-white/75 lg:text-left">
      <div
        className="flex justify-center border-b border-neutral-200 p-6 dark:border-white/10 lg:justify-between">
      <div
      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            <h6
              className="mb-4 flex justify-center font-teko font-semibold uppercase md:justify-start">
             About Us
            </h6>
            <p className="mb-4">
              <a href="#!">Contact</a>
