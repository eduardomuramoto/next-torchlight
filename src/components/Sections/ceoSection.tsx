...
export default function CeoSection({title, subTitle, paragraphs, imgUrl, style="orange", reverse=false, smallPicture=false }:{title:string, subTitle:string, paragraphs:string[], imgUrl?:StaticImageData, style?:string, reverse?:boolean, smallPicture?:boolean}) {
