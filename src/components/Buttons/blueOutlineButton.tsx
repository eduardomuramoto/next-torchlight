...
export default function BlueOutlineButton({label, beforeIcon, afterIcon }:{ label:string, beforeIcon?: string, afterIcon?:string}) {
  return (
    <button className="group flex items-center text-nowrap justify-center bg-white transition-all duration-150 ease-in-out hover:bg-background border-2 border-background text-background font-semibold hover:text-white py-2 px-4 rounded">
