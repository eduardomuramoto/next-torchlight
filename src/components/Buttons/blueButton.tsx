...
export default function BlueButton({label, beforeIcon, afterIcon }:{ label:string, beforeIcon?: string, afterIcon?:string}) {
  return (
    <button className="flex bg-background transition-all duration-150 ease-in-out hover:bg-blue-800 text-white font-semibold hover:text-white py-2 px-4 rounded">
